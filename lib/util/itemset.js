...
const setMixin = {
    ...
    copy: function copy () { return new ItemSet(this._items); },
...
"filter slice map".split(' ').forEach(function (e) {
    setMixin[e] = function () { return new ItemSet(Array.prototype[e].apply(this._items, arguments), true); };
});

var ItemSet = typal.construct(setMixin).mix({
    union: function (a, b) {
        var ar = {};
